package com.agridata.grasstong.wegiht.bottomPopupDialog;
...
public class BottomPopupListAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (mRedPositions != null && mRedPositions.contains(position)) {
            holder.textView.setTextColor(mContext.getResources().getColor(R.color.colorRed));
        }
        else {
            holder.textView.setTextColor(mContext.getResources().getColor(R.color.color_3));
        }
        return convertView;
    }
