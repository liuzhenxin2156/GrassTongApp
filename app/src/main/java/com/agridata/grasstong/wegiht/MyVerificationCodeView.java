package com.agridata.grasstong.wegiht;
...
public class MyVerificationCodeView extends RelativeLayout {
    ...
    public MyVerificationCodeView(Context context) {
        this(context, null);
    }
    ...
    public MyVerificationCodeView(Context context, AttributeSet attrs, int defStyleAttr) {
