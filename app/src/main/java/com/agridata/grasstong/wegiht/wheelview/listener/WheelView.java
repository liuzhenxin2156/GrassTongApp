package com.agridata.grasstong.wegiht.wheelview.listener;
...
import com.agridata.grasstong.wegiht.wheelview.adapter.WheelAdapter;
import com.agridata.grasstong.wegiht.wheelview.listener.lib.OnItemSelectedListener;
import com.agridata.grasstong.wegiht.wheelview.model.IPickerViewData;
...
public class WheelView extends View {
    ...
    public WheelView(Context context, AttributeSet attrs) {
       ...
       /* textColorOut = getResources().getColor(R.color.pickerview_wheelview_textcolor_out);
        ...
        textSize = getResources().getDimensionPixelSize(R.dimen.text_size_20);//默认大小
