...
import com.agridata.grasstong.wegiht.wheelview.listener.lib.CustomListener;
import com.agridata.grasstong.wegiht.wheelview.view.BasePickerView;
import com.agridata.grasstong.wegiht.wheelview.view.WheelOptions;
...
public class OptionsPickerView<T> extends BasePickerView implements View.OnClickListener {
    ...
    private void initView(Context context) {
        ...
        if (customListener == null) {
            ...
            //设置文字
            btnSubmit.setText(TextUtils.isEmpty(Str_Submit) ? context.getResources().getString(R.string.isok) : Str_Submit);
            btnCancel.setText(TextUtils.isEmpty(Str_Cancel) ? context.getResources().getString(R.string.isno) : Str_Cancel);
