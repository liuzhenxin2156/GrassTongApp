package com.agridata.grasstong.wegiht.wheelview;

import android.view.View;


import com.agridata.grasstong.R;
import com.agridata.grasstong.wegiht.wheelview.adapter.ArrayWheelAdapter;
import com.agridata.grasstong.wegiht.wheelview.adapter.NumericWheelAdapter;
import com.agridata.grasstong.wegiht.wheelview.listener.WheelView;
import com.agridata.grasstong.wegiht.wheelview.listener.lib.OnItemSelectedListener;
import com.agridata.grasstong.wegiht.wheelview.utils.ChinaDate;
import com.agridata.grasstong.wegiht.wheelview.utils.LunarCalendar;
...
public class WheelTime {
    ...
    private void setDividerType() {
        wv_day.setDividerType(this.dividerType);
        wv_month.setDividerType(this.dividerType);
        wv_year.setDividerType(this.dividerType);
        wv_hours.setDividerType(this.dividerType);
        wv_mins.setDividerType(this.dividerType);
        wv_seconds.setDividerType(this.dividerType);
