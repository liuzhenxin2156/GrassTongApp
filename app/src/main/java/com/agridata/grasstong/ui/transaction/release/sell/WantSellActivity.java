package com.agridata.grasstong.ui.transaction.release.sell;
 ...
 * @Description :
 */
public class WantSellActivity extends BaseActivity implements View.OnClickListener {
    ...
    public static void start(Context context) {
        Intent intent = new Intent(context, WantSellActivity.class);
        context.startActivity(intent);
    }

    @Override
    protected int getContentViewId() {
        return R.layout.activity_want_sell;
    }
        ...
        specification_et.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                Observable.timer(2, TimeUnit.SECONDS)
                        ...
                        .subscribe(aLong -> {
                            KeyBoardUtil.closeKeyboard(WantSellActivity.this);
                        });
            }
        });
        String[] country = getResources().getStringArray(R.array.country_array);
        //3.实例化数组适配器对象
        ArrayAdapter<String> adapter = new ArrayAdapter<String>(WantSellActivity.this,
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            ...
            case R.id.up_buy_info_btn:
                ToastUtil.showToast(this,"恭喜你！售卖信息发布成功");
                    finish();
                break;
            default:
        }
    ...
    private void checkPermission() {
        PermissionX.init(this).permissions(Manifest.permission.CAMERA).request((allGranted, grantedList, deniedList) -> {
            if (allGranted) {
                ...
                ToastUtil.showToast(WantSellActivity.this, "请开启照相机权限！");
    ...
    private String photo(String imageName, ImageView imageView) {
        ...
        String newPath = AppUtil.createAppStorageDir(AppUtil.PATH_APP_IMAGE, WantSellActivity.this) + "/" + System.currentTimeMillis() + ".jpeg";
