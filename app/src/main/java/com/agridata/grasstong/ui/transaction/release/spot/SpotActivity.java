package com.agridata.grasstong.ui.transaction.release.spot;
 ...
 * @Description :
 */
public class SpotActivity extends BaseActivity implements CustomLinkagePrimaryAdapterConfig.OnPrimaryItemClickListener, ElemeLinkageSecondaryAdapterConfig.OnSecondaryItemClickListener,View.OnClickListener{
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            case R.id.want_buy_btn:
                WantBuyActivity.start(SpotActivity.this);
                break;
            case R.id.want_sell_btn:
                WantSellActivity.start(SpotActivity.this);
                break;
            default:
        }
    }
    ...
    public static List<CustomGroupedItem> getCustomGroupItems() {
        ...
        items.add(new CustomGroupedItem(new CustomGroupedItem.ItemInfo("需方","需方",ContextCompat.getDrawable(mContext,R.drawable.grass_iv),"梯牧草","北京宝讯科技有限公司","500吨")));
        items.add(new CustomGroupedItem(new CustomGroupedItem.ItemInfo("需方","需方",ContextCompat.getDrawable(mContext,R.drawable.grass_iv),"梯牧草","北京宝讯科技有限公司","500吨")));
        items.add(new CustomGroupedItem(new CustomGroupedItem.ItemInfo("需方","需方",ContextCompat.getDrawable(mContext,R.drawable.grass_iv),"梯牧草","北京宝讯科技有限公司","500吨")));items.add(new CustomGroupedItem(new CustomGroupedItem.ItemInfo("需方","供方",ContextCompat.getDrawable(mContext,R.drawable.grass_iv),"梯牧草","北京宝讯科技有限公司","500吨")));
        return items;
    }
