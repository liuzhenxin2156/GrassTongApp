package com.agridata.grasstong.ui.transaction.release.forwardsell;
 ...
 * @Description :
 */
public class ForwardSellActivity extends BaseActivity implements View.OnClickListener {
    ...
    public static void start(Context context) {
        Intent intent = new Intent(context, ForwardSellActivity.class);
        context.startActivity(intent);
    }

    @Override
    protected int getContentViewId() {
        return R.layout.activity_forward_sell;
    }
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.up_buy_info_btn:
                ToastUtil.showToast(this, "恭喜你！远期订单售卖发布成功");
                finish();
                break;
            default:
        }
