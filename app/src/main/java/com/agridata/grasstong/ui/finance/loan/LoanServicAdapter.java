 ...
 * @Description :
 */
public class LoanServicAdapter extends BaseRecyclerViewAdapter<GrassBean, BaseRecyclerViewHolder> {
    final  private List<GrassBean> mDates;
   final private Context mContext;


    public LoanServicAdapter(int layoutResId, List<GrassBean> dataList, Context context) {
    ...
    protected void convert(BaseRecyclerViewHolder viewHolder, GrassBean data, final int position) {
        ...
        switch (position) {
            case 0:
                imageView.setImageDrawable(ContextCompat.getDrawable(mContext,R.drawable.ic_loan_bt));
                break;
            case 1:
                imageView.setImageDrawable(ContextCompat.getDrawable(mContext,R.drawable.ic_loan_farmland));
                break;
            case 2:
                imageView.setImageDrawable(ContextCompat.getDrawable(mContext,R.drawable.ic_loan_fertilizer));
                break;
